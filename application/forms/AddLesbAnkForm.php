...
class Form_AddLesbAnkForm extends Form_AddAnkForm
{
	public function init() {
		...
		*/
		...
		$this->addDisplayGroup(array(
				...
				'info',
				array("legend" => "Параметры 1-ой девушки.")
		);	
		...
		list($height_min,$height_max)=explode('-',$this->content->height);
		$this->addElement('text', 'height_2', array(
				'filter' => array('StringTrim'),
				'validators' => array(
						array (
								'NotEmpty', array('breakChainOnFailure' => true), array('messages' => array(
		...
		list($weight_min,$weight_max)=explode('-',$this->content->weight);
		$this->addElement('text', 'weight_2', array(
				'filter' => array('StringTrim'),
				'validators' => array(
						array(
								'NotEmpty', array('breakChainOnFailure' => true), array('messages' => array(
		...
		list($age_min,$age_max)=explode('-',$this->content->age);
		$this->addElement('text', 'age_2', array(
			'filter' => array('StringTrim'),
			'validators' => array( 
				array(
					'NotEmpty', array('breakChainOnFailure' => true), array('messages' => array(
				...
				array(
					'GreaterThan', false, array($age_min, 'messages' => array(
						Zend_Validate_GreaterThan::NOT_GREATER => sprintf( self::NOT_RANGE, $age_min, $age_max)
				))),
				array(
					'LessThan', false, array($age_max, 'messages' => array(
						Zend_Validate_LessThan::NOT_LESS => sprintf( self::NOT_RANGE, $age_min, $age_max)
				)))
			),	
			'required' => true,
		...
		$this->addElement('text', 'clothing_2', array(
				'filter' => array('StringTrim'),
				'validators' => array(
						array(
								'Int', false, array('messages' => array(
		...
		list($breast_min,$breast_max)=explode('|',$this->content->breast);
		$this->addElement('select', 'breast_2', array(
				'validators' => array(
						array(
								'GreaterThan', false, array($breast_min, 'messages' => array(
										Zend_Validate_GreaterThan::NOT_GREATER => sprintf( self::NOT_RANGE, $breast_min, $breast_max)
		...
		$this->addDisplayGroup(array(
				...
				'info2',
				array("legend" => "Параметры 2-ой девушки.")
		);
		...
		$this->addElement('text', 'name_eng', array(
			...
			'required' => true,
			'label'    => 'Имя 1-ой девушки: (на англ.)',
			'decorators' => array(
				'ViewHelper',
				'Errors',
				array('Label', array('class' => 'control-label', 'style' => 'width: 270px')),
		...
		$this->addElement('text', 'name_eng_2', array(
				'filter' => array('StringTrim'),
				'validators' => array(
						array(
							'NotEmpty', false, array('messages' => array(
				...
				'required' => true,
				'label'    => 'Имя 2-ой девушки: (на англ.)',
				'decorators' => array(
					'ViewHelper',
					'Errors',
					array('Label', array('class' => 'control-label', 'style' => 'width: 270px')),
